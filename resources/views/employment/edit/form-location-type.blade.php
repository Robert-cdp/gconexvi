<div class="grid sm:grid-cols-2 gap-4">
    <div>
        ...
        <select
            ...
            <option value="" disabled {{ old('type', $employment->type) ? '' : 'selected' }}>Selecciona una modalidad</option>
            <option value="remote" @selected(old('type', $employment->type) === 'remote')>Remoto</option>
            <option value="hybrid" @selected(old('type', $employment->type) === 'hybrid')>Híbrido</option>
            <option value="onsite" @selected(old('type', $employment->type) === 'onsite')>Presencial</option>
        </select>
    ...
    <div>
        ...
        <input
            ...
            id="location"
            name="location"
            value="{{ old('location', $employment->location) }}"
