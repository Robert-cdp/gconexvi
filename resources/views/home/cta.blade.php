<section class="py-20 bg-gradient-to-br from-primary-600 to-primary-800 text-white">
    <div class="max-w-4xl mx-auto px-6 text-center">
        ...
        <div class="mt-8 flex flex-wrap justify-center gap-4">
            <a href="{{ route('register') }}" class="px-8 py-4 bg-white text-primary-700 font-bold rounded-xl hover:bg-primary-50 shadow-xl transition-all">
                Crear cuenta gratis
            </a>
{{-- 
            <button
        ...
        <p class="mt-6 text-sm text-primary-200">Registro gratis · Configuración en 2 minutos</p>
    </div>
</section>
