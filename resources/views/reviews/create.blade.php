    ...
    <section class="max-w-3xl mx-auto px-6 py-10">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-slate-600">
                Comparte tu experiencia sobre <strong>{{ $reviewable->title }}</strong>.
            ...
            <form action="{{ route('reviews.store') }}" method="POST" class="space-y-8">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        @for ($i = 1; $i <= 5; $i++)
                            <button
                                ...
                                <svg
                                    class="w-9 h-9 transition duration-150"
                                    :class="rating >= {{ $i }}
                                        ? 'text-yellow-400'
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="block w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-700 placeholder:text-slate-400 shadow-sm resize-none transition focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 focus:outline-none">{{ old('comment') }}</textarea>
